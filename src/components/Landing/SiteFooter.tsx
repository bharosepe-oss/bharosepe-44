const SiteFooter = () => {
  return (
    <footer className="bg-background py-10">
      <div className="container mx-auto grid max-w-6xl grid-cols-1 gap-6 px-4 text-base text-foreground sm:grid-cols-3">
        <div className="min-w-0">
          <a href="https://www.bharosepe.co.in/" className="inline-flex items-center gap-3 text-lg font-semibold text-foreground hover:text-primary">
        ...
        <div className="min-w-0">
          <p className="text-sm font-semibold uppercase tracking-widest text-foreground">Quick Links</p>
      ...
      <div className="container mx-auto mt-6 max-w-6xl px-4 text-sm text-muted-foreground">
